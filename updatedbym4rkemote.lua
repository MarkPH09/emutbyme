...
--made by Gi#7331
--edited by Solo Psycho
--(made GUI stay open during emote selection) - Psycho
...
BackFrame.Size = UDim2.new(0.5, 0, 0.8, 0)
...
WatermarkPadding.PaddingTop = UDim.new(0.05, 0)
WatermarkPadding.PaddingBottom = UDim.new(0.05, 0)
